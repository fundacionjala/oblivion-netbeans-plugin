...
/**
 * Verifies that the Set grammar covers the scenarios described at:
 *
 * @see:http://www.salesforce.com/us/developer/docs/apexcode/salesforce_apex_language_reference.pdf
 * @author Alejandro Ruiz
 */
@RunWith(Parameterized.class)
public class SetCollectionSupportTest {

    private final static String RESOURCE_FILE = "resources/SetCollectionSupportScenarios.xml";
    ...
    public SetCollectionSupportTest(String id, String testContent) {
        this.id = id;
