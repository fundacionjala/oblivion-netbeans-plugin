...
/**
 * Verifies that the Map grammar covers the scenarios described at:
 *
 * @see:http://www.salesforce.com/us/developer/docs/apexcode/salesforce_apex_language_reference.pdf
 * @author Alejandro Ruiz
 */
@RunWith(Parameterized.class)
public class MapCollectionSupportTest {

    private final static String RESOURCE_FILE = "resources/MapCollectionSupportScenarios.xml";
    ...
    public MapCollectionSupportTest(String id, String testContent) {
        this.id = id;
