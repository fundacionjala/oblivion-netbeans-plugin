...
@Messages({
    "LBL_Trigger_LOADER=Files of Trigger"
})
@MIMEResolver.ExtensionRegistration(
    displayName = "#LBL_Trigger_LOADER",
    mimeType = MimeType.APEX_TRIGGER_MIME_TYPE,
...
@ActionReferences({
    @ActionReference(
        path = MimeType.APEX_TRIGGER_ACTIONS_PATH,
...
public class TriggerDataObject extends MultiDataObject {

    public TriggerDataObject(FileObject pf, MultiFileLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
        registerEditor(MimeType.APEX_TRIGGER_MIME_TYPE, true);
    }
    ...
    @MultiViewElement.Registration(
        displayName = "#LBL_Trigger_EDITOR",
        iconBase = "org/fundacionjala/oblivion/apex/resources/apexDevIcon16.png",
        mimeType = MimeType.APEX_TRIGGER_MIME_TYPE,
    ...
    @Messages("LBL_Trigger_EDITOR=Source")
